...
/*
UserEventApiService Get your user events
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *UserEventApiUserEventGetOpts - Optional Parameters:
     * @param "Count" (optional.Float64) -  Number of results to fetch.
     * @param "StartId" (optional.Float64) -  Cursor for pagination.

@return []UserEvent
*/

type UserEventApiUserEventGetOpts struct {
