 ...
 * @param optional nil or *QuoteApiQuoteGetOpts - Optional Parameters:
...
type QuoteApiQuoteGetOpts struct {
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *QuoteApiQuoteGetBucketedOpts - Optional Parameters:
...
type QuoteApiQuoteGetBucketedOpts struct {
